...
<section class="hero section">
    <div class="container">
        ...
        <div class="row" data-aos="fade-up">
            <div class="w-75 p-3">
                <form action="{{ route('masukLaporan') }}" method="POST" onsubmit="return validateForm()" id="buatLaporan" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="001" style="display:block;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" onclick="coba()" name="_001[]" value="N" id="_001_0">
                                <label class="form-check-label" for="_001_0">
                                    Tidak Sholat
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="_001[]" value="S" id="_001_1">
                                <label class="form-check-label" for="_001_1">
                                    Shubuh
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="_001[]" value="Z" id="_001_2">
                                <label class="form-check-label" for="_001_2">
                                    Dzuhur
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="_001[]" value="A" id="_001_3">
                                <label class="form-check-label" for="_001_3">
                                    Ashar
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="_001[]" value="M" id="_001_4">
                                <label class="form-check-label" for="_001_4">
                                    Maghrib
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="_001[]" value="I" id="_001_5">
                    ...
                    <div id="002" style="display:none;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_002" value="Y" id="_002_1">
                                <label class="form-check-label" for="_002_1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_002" value="N" id="_002_2">
                    ...
                    <div id="003" style="display:none;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_003" value="Y" id="_003_1">
                                <label class="form-check-label" for="_003_1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_003" value="N" id="_003_2">
                    ...
                    <div id="004" style="display:none;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_004" value="Y" id="_004_1">
                                <label class="form-check-label" for="_004_1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_004" value="N" id="_004_2">
                    ...
                    <div id="005" style="display:none;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_005" value="Y" id="_005_1">
                                <label class="form-check-label" for="_005_1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_005" value="N" id="_005_2">
                    ...
                    <div id="007" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="_007" value="Y" id="_007_1">
                    ...
                    <div id="009" style="display:none;">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_009" value="Y" id="009_1">
                                <label class="form-check-label" for="009_1">
                                    Ya
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="_009" value="N" id="009_2">
                    ...
                    <div id="010" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_010" aria-label="Default select example" id="010">
                                ...
                                @for($i = 0; $i < count($hasil1); $i++) <option value="{{ ($i+1) }}">{{ $hasil1[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="011" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_011" aria-label="Default select example" id="011">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil2); $i++) <option value="{{ ($i+1) }}">{{ $hasil2[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="012" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_012" aria-label="Default select example" id="012">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil3); $i++) <option value="{{ ($i+1) }}">{{ $hasil3[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="013" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_013" aria-label="Default select example" id="013">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil4); $i++) <option value="{{ ($i+1) }}">{{ $hasil4[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="014" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_014" aria-label="Default select example" id="014">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil5); $i++) <option value="{{ ($i+1) }}">{{ $hasil5[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="015" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_015" aria-label="Default select example" id="015">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil6); $i++) <option value="{{ ($i+1) }}">{{ $hasil6[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="016" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_016" aria-label="Default select example" id="016">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil7); $i++) <option value="{{ ($i+1) }}">{{ $hasil7[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
                    ...
                    <div id="017" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="_017" aria-label="Default select example" id="017">
                                <option value="" hidden selected>Open this select menu</option>
                                @for($i = 0; $i < count($hasil8); $i++) <option value="{{ ($i+1) }}">{{ $hasil8[$i] }}</option>
                                    @endfor
                            </select>
                            </br>
                        </div>
